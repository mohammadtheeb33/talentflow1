                    ...
                    <div className="grid gap-2 text-sm">
                      <div className="flex items-start justify-between rounded-md border border-gray-100 bg-white p-3 shadow-sm">
                        ...
                        <span className="font-medium text-gray-900 select-all">
                          {cv?.extractedContact?.email || cv?.parsed?.email || cv?.email || <span className="text-red-600">Not Found</span>}
                        </span>
                      </div>
                      <div className="flex items-start justify-between rounded-md border border-gray-100 bg-white p-3 shadow-sm">
                        <span className="text-gray-500">Phone</span>
                        <span className="font-medium text-gray-900 select-all">
                          {cv?.extractedContact?.phone || cv?.parsed?.phone || <span className="text-red-600">Not Found</span>}
                        </span>
                      </div>
                      <div className="flex items-start justify-between rounded-md border border-gray-100 bg-white p-3 shadow-sm">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="rounded-md border border-gray-100 bg-gray-50 p-3 text-xs text-gray-600 whitespace-pre-wrap leading-relaxed">
                       {cv?.parsed?.courses || <span className="italic text-gray-500">No courses found.</span>}
                    </div>
                  </div>
                </div>
              )}
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-5">
              ...
              <div className="mt-6 space-y-4 max-h-[300px] overflow-y-auto pr-2">
                ...
                {notes.length === 0 && (
                  <p className="text-center text-xs text-gray-500 py-4">No notes added yet.</p>
                )}
              </div>
            </div>
